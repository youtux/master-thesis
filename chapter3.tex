...
Figure~\ref{fig:incoming_citations_distribution_pdf} compares the distribution of citations of all the papers known to the MAG (circa 120 millions) and the ones whose \ac{DOI} appears in Wikipedia (circa 389 thousands).
...
For instance, the 74\% of papers in Wikipedia have at least 10 incoming citations, while only the 13\% of papers taken random from the \ac{MAG} have at least 10 incoming citations.
...
This is expected because every year authors replicates and extends previous works and only the newer ones tend to be cited.
...
Considering the fact that more than the 20\% of irrelevant \acp{ISBN} and \acp{DOI} are removed within the first day, we conclude that the effort made by Wikipedia community to remove irrelevant references inside the articles is both remarkable and effective.
